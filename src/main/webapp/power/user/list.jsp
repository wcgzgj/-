 ...
 <div class="cztable" style="width: 100%;">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <c:forEach items="${pageUtil.dataList}" var="user" varStatus="st">
                    <tr align="center">
                        ...
                        <td>
                            <a href="info.html">${user.realName}</a>
                        </td>
          ...
          <div class='MainStyle'>
              <div class=''>
                <a href='/power/user/users?method=userManage' target='_self'>首页</a>
              </div>
              <div class=''>
                  <a href='/power/user/users?method=userManage&pageIndex=${pageUtil.pageIndex-1<=0?1:pageIndex-1}' target='_self'>上一页</a>
              </div>
              <div class=''>
                  <a href='/power/user/users?method=userManage&pageIndex=${pageUtil.pageIndex+1>=pageUtil.totalPages?pageUtil.totalPages:pageIndex+1}' target='_self'>下一页</a>
              </div>
              <div class=''>
                  <a href='/power/user/users?method=userManage&pageIndex=${pageUtil.totalPages}' target='_self'>尾页</a>
              </div>
